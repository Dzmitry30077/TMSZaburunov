			...
			<div className="row">
				...
				<div className="col-md-7">
					<div className="card-block">
						<h2 className="card-title"><a href="post.html">{title.slice(0, 60) + '...'}</a></h2>
						...
						<div className="metafooter">
							<div className="wrapfooter">
								...
								<span className="post-date">{postDate}</span><span className="dot"></span><span className="post-read">{postRead}</span>
								</span>
